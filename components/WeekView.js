...
import Event from './WeekView/Event/Event';
import Events from './WeekView/Events/Events';
import Header from './WeekView/Header/Header';
import Title from './WeekView/Title/Title';
import Times from './WeekView/Times/Times';
      ...
      <View style={styles.container}>
        ...
        <ScrollView
          ...
          <View style={styles.scrollViewContent}>
            <Times
              // times={times}
              times={[{"name":"Room 1 "},{"name":"Room 2 "},
                      {"name":"Room 3 "},{"name":"Room 4 "}]}
